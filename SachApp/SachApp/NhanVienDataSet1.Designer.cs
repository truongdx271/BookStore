...
namespace SachApp {
    ...
    public partial class NhanVienDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/NhanVienDataSet1.xsd";
...
namespace SachApp.NhanVienDataSetTableAdapters {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[NhanVien] WHERE (([MANV] = @Original_MANV) AND ((@IsNull_TENNV" +
                " = 1 AND [TENNV] IS NULL) OR ([TENNV] = @Original_TENNV)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NhanVien] ([TENNV]) VALUES (@TENNV);\r\nSELECT MANV, TENNV FROM " +
                "NhanVien WHERE (MANV = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[NhanVien] SET [TENNV] = @TENNV WHERE (([MANV] = @Original_MANV) AND" +
                " ((@IsNull_TENNV = 1 AND [TENNV] IS NULL) OR ([TENNV] = @Original_TENNV)));\r\nSEL" +
                "ECT MANV, TENNV FROM NhanVien WHERE (MANV = @MANV)";
        ...
        public virtual int Delete(int Original_MANV, string Original_TENNV) {
        ...
        public virtual int Insert(string TENNV) {
            if ((TENNV == null)) {
        ...
        public virtual int Update(string TENNV, int Original_MANV, string Original_TENNV, int MANV) {
            if ((TENNV == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TENNV, int Original_MANV, string Original_TENNV) {
            return this.Update(TENNV, Original_MANV, Original_TENNV, Original_MANV);
        }
    }
